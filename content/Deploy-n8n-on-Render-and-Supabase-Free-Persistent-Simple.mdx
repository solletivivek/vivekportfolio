...
Here's a clean, step-by-step guide based on what actually worked in our setup—using **Render** to host n8n and **Supabase Postgres** for persistent storage, all on free tiers.
